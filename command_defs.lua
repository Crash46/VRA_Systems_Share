Keys =
{
	...
	iCommandPlaneFlapsOn = 145, -- Fully down
	iCommandPlaneFlapsOff = 146, -- Fully up
	iCommandPlaneWingtipSmokeOnOff = 78, -- Smoke
	iCommandMasterBattery = 500, -- Master Battery
	...
	PlaneFonar = 71,  -- Cockpit Toggle Test
...
Button_202	=	start_command	+	202; --UHF
Button_203	=	start_command	+	203; --UHF
